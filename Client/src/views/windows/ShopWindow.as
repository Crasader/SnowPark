...
public class ShopWindow extends BaseWindow
{
	...
	private function init():void
	{
		...
		ButtonUtil.setButton(buttonDecor, function (e:Event):void
		{
			setNewState(DECOR);
		});

		ButtonUtil.setButton(buttonKicker, function (e:Event):void
		{
			setNewState(KICKER);
		});
		ButtonUtil.setButton(buttonBuild, function (e:Event):void
		{
			setNewState(BUILD);
		});
